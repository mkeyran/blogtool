"""Post creation dialog for regular blog posts."""
...
class PostDialog(QDialog):
    """Dialog for creating new blog posts."""
    ...
    def _setup_ui(self):
        ...
        self.title_edit.setPlaceholderText("Enter post title...")
        ...
        self.description_edit.setPlaceholderText("Brief description of the post...")
        form_layout.addRow("Description:", self.description_edit)

        # Tags
        self.tags_edit = QLineEdit()
        self.tags_edit.setPlaceholderText("Comma-separated tags (e.g., AI, Technology, Blog)")
        ...
        self.create_btn = QPushButton("Create Post")
    ...
    def _update_previews(self):
        ...
        path = f"content/{language_dir}/posts/{self.slug}/index.md"
    ...
    def get_post_data(self) -> Optional[dict]:
        """Get the post data from form inputs."""
